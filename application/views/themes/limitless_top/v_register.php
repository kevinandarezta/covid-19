        ...
        <form class="login-form form-horizontal cmxform" method="post" id="commentForm" action="{BASE_URL}pages/content/user/action/add">
          <div class="card mb-0">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                <input type="text" class="form-control" name="whatsapp" id="whatsapp" maxlength="13" value="" placeholder="Whatsapp" onkeypress="return number(event)" required>
              </div>

              <div class="form-group">
                <input type="text" class="form-control" name="city" id="city" placeholder="City" onkeypress="return string(event)" required>
              </div>
